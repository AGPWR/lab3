public class Figury {
    interface JednoArg {
        public double ObliczPole(int arg1);
        public double ObliczObwod(int arg1);
    }
    
    interface DwuArg {
        public double ObliczPole(int arg1, int arg2);
        public double ObliczObwod(int arg1, int arg2);
    }
